...
def create_channel(
    ...
    channel_name: str,
) -> common_measurement.ChannelWriter[str]:
    serializer = Serializer(common_measurement.DataTypeInformation)
...
def open_channel(
    ...
    channel_name: str,
) -> common_measurement.ChannelReader[str]:
    deserializer = Serializer(common_measurement.DataTypeInformation)
